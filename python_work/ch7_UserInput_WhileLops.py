...
#	You can prompt for as much input as you as you need in each pass 
# through a while loop. Let's make a polling program in which each pass
# through the loop prompts for the participant's name and response. 
